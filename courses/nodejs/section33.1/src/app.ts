...
we learned how to use TS with node.js

TS gives many useful features
that allows to write better, less error prone code
which has many built in checks during 
compilation, development

which avoids errors at runtime 
when we then execute our code

node itself is not able to execute TS code

to run our app using node
# node dist/app.js

we write code the same way we wrote it before
but with extra lines of TS
