...
//so we can run multiple queries simultaniously
...
const pool = mysql.createPool({
    ...
    //define the exact database name, beacuse it gives us access to a db server
        //but this server typically has multiple databases
        //here our databses are our schemas in the program
    //our password
    host: "localhost", 
    user: "root",
