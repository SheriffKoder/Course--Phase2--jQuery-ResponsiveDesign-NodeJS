...
//(22.0.2)
//when we send requests through client/browser side js
//we have access to other http verbs than get/post (of form submits and url access)
//you can use any http verb/method
//but to be clear about your intention can use router.delete
//..
//the path will be a dynamic parameter, param, to be extracted from the url
//change also the controller name
